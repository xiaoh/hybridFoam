...
addToRunTimeSelectionTable(muRASModel, laminar, dictionary);
...
tmp<volScalarField> laminar::nut() const
{
    ...
    (
        ...
        (
            ...
            mesh_,
            dimensionedScalar("nutR", nu().dimensions(), 0.0)
        )
    );
}
...
tmp<volScalarField> laminar::k() const
{
    ...
    (
        ...
        (
            ...
            mesh_,
            dimensionedScalar("kR", sqr(U_.dimensions()), 0.0)
        )
    );
}
...
tmp<volScalarField> laminar::epsilon() const
{
    ...
    (
        ...
        (
            ...
            dimensionedScalar
            (
                "epsilonR", sqr(U_.dimensions())/dimTime, 0.0
            )
        )
    );
}
