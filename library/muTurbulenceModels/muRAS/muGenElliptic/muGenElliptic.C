...
:
    ...
    (
        ...
        mesh_,
        dimensionedSymmTensor("qrr", dimVelocity*dimVelocity/dimTime, symmTensor::zero)
    ),
...
Foam::tmp<Foam::volTensorField> muGenElliptic::symm2full( volSymmTensorField& symm ) const
{
